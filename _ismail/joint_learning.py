...
def sflex_gamma_lambda_map(L, y, X, sigma, init_gamma=None, init_lambda=None, update_mode_noise=2, 
    ...
    posterior_cov : array
        Posterior covariance of active sources
    learned_lambda : array
        Learned noise variance
    """
    # Compute basis matrix (you have already B)
    B = compute_B(X, sigma, threshold_factor) #sigma =0.01 and X is the source coordinates on the cortical surface
    N = X.shape[0]
