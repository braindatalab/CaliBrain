...
# -----------------------------------------------------------------
#
# For fixed orientation, uncertainty estimation reduces the posterior covariance
# to one variance per source. This is the representation used downstream for
# fixed-orientation aggregated calibration.
...
# ------------------------------------
#
# The first panel shows the fixed-orientation aggregated interval for one active
# source. The second panel compares the pre-calibration curves across the three
# uncertainty representations used here.
...
axes[1].set(
    ...
    title="Pre-calibration curves by uncertainty type",
)
axes[1].legend(loc="best")
fig.tight_layout()

# %%
# Inspect one free-orientation source more closely
# ------------------------------------------------
#
# This second plot isolates the free-EEG case. The left panel shows aggregated
# component means with component-wise marginal uncertainty. The right panel
# compares the two free-orientation coverage diagnostics.
...
axes[1].set(
    xlabel="Nominal coverage",
    ylabel="Empirical coverage",
    title="Free EEG coverage diagnostics",
)
axes[1].legend(loc="best")
fig.tight_layout()
