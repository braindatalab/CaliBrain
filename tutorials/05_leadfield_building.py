...
# - source coordinates associated with the leadfield are represented in ``m``.
#
# This means:
#
# - ``(fT / nAm) × nAm = fT`` at MEG sensors;
# - ``(µV / nAm) × nAm = µV`` at EEG sensors.
