...
class DataSimulator:
    ...
    def __init__(
        ...
        mne_info_path: Optional[Union[str, Path]] = None
    ):
        """
    ...
    def simulate(self, subject, global_seed, visualize: bool = True, save_path: str = "results/figures/data_sim/") -> Tuple[np.ndarray, np.ndarray, np.ndarray, np.ndarray, np.ndarray]:
        ...
        visualize : bool, optional
            ...
            Requires `leadfield_mode` to be 'simulate' or a valid `leadfield_config_path` to be provided for obtaining MNE info.
