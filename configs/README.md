...
- **Data Generation** – Generates synthetic experiments, runs every inverse solver/hyperparameter combination, and records posterior summaries. This stage is the “data factory” that populates calibration datasets under the configured simulation grid.
